  ...
  <div>
    ...
    <div style="height: 60px; line-height: 60px; background-color: white; margin-bottom: 2px; display: flex">
      <div style="width: 300px">
        <img alt="" src="@/assets/logo.png" style="width: 40px; position: relative; top: 10px; left: 20px">
    ...
    <div style="display: flex">
      ...
      <div
        ...
        <el-menu :default-active="$route.path==='/'?$route.path:$route.path.substring(1)" :default-openeds="['/']"
                 class="el-menu-demo" router>
          <el-menu-item index="/">
